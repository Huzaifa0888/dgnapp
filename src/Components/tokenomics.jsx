...
function Tokenomics() {
        ...
        <div className="flex flex-col items-center mt-10 mb-20">
          ...
          <span className="text-white mt-3 text-[18px] flex  font-medium text-center">
            ...
            <span className="lg:block md:block sm:block hidden">
              cb2f1841858c2643722dc7
            </span>
            <span className="lg:hidden md:hidden sm:hidden block">
              ..........
            </span>
          </span>
 ...
 justify-start overflow-x-hidden  relative mt-20 h-[550px] "
        >
          ...
          <div className="lg:absolute  flex  top-[42%] justify-between  overflow-hidden  ">
            ...
            <div className="   mt-12  w-[400px]">
              ...
              <div className="ml-[198px] border-r-0 border-b-0 border-t-0 mx-auto w-[100px] border-[1px] border-solid border-[#dc12fc] h-[30px] opacity-50"></div>
